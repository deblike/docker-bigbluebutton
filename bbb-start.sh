...
#Set new hostname
sed -i s/HOST/$IP/g /root/dev/bigbluebutton/bigbluebutton-client/client/conf/config.xml
sed -i s/https/http/g /root/dev/bigbluebutton/bigbluebutton-client/client/conf/config.xml
bbb-conf --setip $IP
